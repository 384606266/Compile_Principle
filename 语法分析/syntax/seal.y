...
%{
  ...
  for the location of tokens */
    ...
    extern int node_lineno;          /* set before constructing a tree node to whatever you want 
                                    the line number for the tree node to be */
...
%%
    ...
    /* 𝑊ℎ𝑖𝑙𝑒𝑆𝑡𝑚𝑡 := while Expr Stmtblock  */
